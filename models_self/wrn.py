...
class WideResNet(nn.Module):
    def __init__(self, depth, num_classes, feat_t, fx, widen_factor=1, dropRate=0.0):
        ...
        # here
        self.conv_embed = [
                        nn.Conv2d(nChannels[0], feat_t[0].size(1), kernel_size=1, stride=1,padding=0, bias=False),
                        nn.Conv2d(nChannels[1], feat_t[1].size(1), kernel_size=1, stride=1,padding=0, bias=False),
                        nn.Conv2d(nChannels[2], feat_t[2].size(1), kernel_size=1, stride=1,padding=0, bias=False),
                        nn.Conv2d(nChannels[3], feat_t[3].size(1), kernel_size=1, stride=1,padding=0, bias=False),
                    ]
