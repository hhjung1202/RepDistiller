python3.5 ../train_student.py --path_t ./save/models/wrn_40_2_vanilla/ckpt_epoch_240.pth --model_s wrn_16_2 --distill self --pos 1 0 0 0 -r 0.1 -a 0.9 -b 0.1 -c 0.45 -d 0.05 --fx 0 --gpu 0 --trial 1 1>A_1 &
python3.5 ../train_student.py --path_t ./save/models/wrn_40_2_vanilla/ckpt_epoch_240.pth --model_s wrn_16_2 --distill self --pos 0 1 0 0 -r 0.1 -a 0.9 -b 0.1 -c 0.45 -d 0.05 --fx 1 --gpu 0 --trial 2 1>A_2 &
python3.5 ../train_student.py --path_t ./save/models/wrn_40_2_vanilla/ckpt_epoch_240.pth --model_s wrn_16_2 --distill self --pos 0 0 1 0 -r 0.1 -a 0.9 -b 0.1 -c 0.45 -d 0.05 --fx 2 --gpu 0 --trial 3 1>A_3 &
...
python3.5 ../train_student.py --path_t ./save/models/wrn_40_2_vanilla/ckpt_epoch_240.pth --model_s wrn_16_2 --distill self --pos 0 0 0 1 -r 0.01 -a 0.09 -b 0.1 -c 0.045 -d 0.005 --projection 200 --fx 3 --gpu 4 --trial 11 1>D_1 &
